...
[[ -f $HOME/.xlock/icon.png ]] && convert $TEMPDIR/head_0.png $HOME/.xlock/icon.png -gravity center -composite -matte $TEMPDIR/head_0.png
if [ -e $TEMPDIR/head_1.png ]; then
  convert $TEMPDIR/head_1.png -scale 10% -scale 1000% $TEMPDIR/head_1.png
  [[ -f $HOME/.xlock/icon.png ]] && convert $TEMPDIR/head_1.png $HOME/.xlock/icon.png -gravity center -composite -matte $TEMPDIR/head_1.png
